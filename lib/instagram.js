...
const Media = igScrap.Media
const User = igScrap.User
const urlParser = igScrap.urlParser
...
Instagram.prototype.clearCache = function (callback) {
  this._redisClient.clearCache(callback)
}
